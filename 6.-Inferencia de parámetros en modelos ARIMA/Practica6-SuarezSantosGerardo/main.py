...
import InferenciaParametros
import pandas as pd

def main():

    file_path = 'F:/ESCOM-activo/Series de Tiempo/Practica6-SuarezSantosGerardo/global_traffic_accidents.csv' #Cambia el nombre del archivo
    ...
    order = InferenciaParametros.infer_parameters(data_series)

    model_fit = ARIMA_train.train_arima_model(data_series, *order)
